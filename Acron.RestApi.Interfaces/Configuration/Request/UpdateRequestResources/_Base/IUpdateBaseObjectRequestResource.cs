...
namespace Acron.RestApi.Interfaces.Configuration.Request.UpdateRequestResponses
{
   ...
   /// !!!!!!!
   /// </remarks>
   public interface IUpdateBaseObjectRequestResource
   {
      /// <summary>
      ...
      [SwaggerExampleValue(new int[] { 300000002, 300000003, 300000004, 300000005, 300000006, 300000007, 300000008, 300000009, 300000010 })]
