...
{
   public interface IGetHandValRawDataDayValue<GetHandValRawDataValueType, GetHandValRawDataFlagType> where GetHandValRawDataValueType : IGetHandValRawDataValue<GetHandValRawDataFlagType>
                                                                                                      where GetHandValRawDataFlagType : IGetHandValRawDataFlag
   {
      ...
      [SwaggerSchema($"Collection of {nameof(IGetHandValRawDataValue<IGetHandValRawDataFlag>)} objects")]
      [SwaggerExampleValue(typeof(List<IGetHandValRawDataValue<IGetHandValRawDataFlag>>))]
      public List<GetHandValRawDataValueType> Data { get; set; }
    }
}
