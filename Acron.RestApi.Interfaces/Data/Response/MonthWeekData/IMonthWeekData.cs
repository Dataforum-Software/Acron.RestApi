...
namespace Acron.RestApi.Interfaces.Data.Response.MonthWeekData
{
   public interface IMonthWeekData<MonthWeekDataFlagType> where MonthWeekDataFlagType : IMonthWeekDataFlag
   {
      ...
      [SwaggerExampleValue(typeof(IMonthWeekDataFlag))]
      public List<MonthWeekDataFlagType> MDAT_FLAG { get; set; }

      //2   	MDAT_MVAL	            double         	Wert
      [SwaggerSchema("Monthly value")]
      [SwaggerExampleValue(new double[] { 179647.0 })]
      public List<double> MDAT_MVAL { get; set; }

      [SwaggerSchema($"{nameof(MDAT_MVAL)} formatted according to 'Culture' Header or value key")]
      [SwaggerExampleValue(new string[] { "179.647,0" })]
      ...
      [SwaggerExampleValue(new string[] { "01.01.1970 00:00:00Z" })]
      ...
      [SwaggerSchema($"{nameof(MDAT_PMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> MDAT_PMINLIM_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(MDAT_PMAXLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> MDAT_PMAXLIM_FORMATTED { get; set; }

      //17	MDAT_PCOUNT	         unsigned	      Anzahl der Prozesswerte
      [SwaggerSchema("Number of process values")]
      [SwaggerExampleValue(new int[] { 2016 })]
      public List<uint> MDAT_PCOUNT { get; set; }

      [SwaggerSchema($"{nameof(MDAT_PCOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[] { "2.016" })]
      List<string> MDAT_PCOUNT_FORMATTED { get; set; }
      ...
      [SwaggerExampleValue(new string[] { "1.179.647,0" })]
      ...
      [SwaggerSchema($"{nameof(MDAT_IMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> MDAT_IMINLIM_FORMATTED { get; set; }
      ...
      [SwaggerExampleValue(new int[] { 84 })]
      public List<uint> MDAT_IMAXLIM { get; set; }

      [SwaggerSchema($"{nameof(MDAT_IMAXLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[] { "84" })]
      List<string> MDAT_IMAXLIM_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(MDAT_ICOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[] { "84" })]
      List<string> MDAT_ICOUNT_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(MDAT_DMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> MDAT_DMINLIM_FORMATTED { get; set; }
      ...
      [SwaggerExampleValue(new int[] { 7, 7, 7 })]
      public List<uint> MDAT_DMAXLIM { get; set; }

      [SwaggerSchema($"{nameof(MDAT_DMAXLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "7", "7", "7"})]
      List<string> MDAT_DMAXLIM_FORMATTED { get; set; }

      //36	MDAT_DCOUNT	         unsigned	      Anzahl der Tageswerte
      [SwaggerSchema("Number of daily values")]
      [SwaggerExampleValue(new int[] { 7 })]
      public List<uint> MDAT_DCOUNT { get; set; }

      [SwaggerSchema($"{nameof(MDAT_DCOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[] { "7" })]
      List<string> MDAT_DCOUNT_FORMATTED { get; set; }
