...
{
   public interface ICompressionForIntervalOfProcessDataResult<T, U> where T : ICompressionForIntervalOfProcessData<U> where U : ICompressionForIntervalOfProcessDataFlag
   {
      ...
      [SwaggerExampleValue(typeof(ICompressionForIntervalOfProcessData<ICompressionForIntervalOfProcessDataFlag>))]
