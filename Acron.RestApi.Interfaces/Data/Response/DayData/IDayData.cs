...
namespace Acron.RestApi.Interfaces.Data.Response.DayData
{
   public interface IDayData<U> where U : IDayDataFlag
   {
      ...
      [SwaggerExampleValue(new double[]{23932.0, 26364.0, 26972.0})]
      List<double> DDAT_DVAL { get; set; }

      [SwaggerSchema($"{nameof(DDAT_DVAL)} formatted according to 'Culture' Header or value key")]
      [SwaggerExampleValue(new string[] { "23,932.0", "26,364.0", "26,972.0" })]
      public List<string> DDAT_DVAL_FORMATTED { get; set; }

      //Bit 3 : DDAT_DVALAVG
      [SwaggerSchema("Floating daily value")]
      [SwaggerExampleValue(new float[] { 21466.0f, 21311.5f, 21788.75f, 22204.25f })]
      List<float> DDAT_DVALAVG { get; set; }

      [SwaggerSchema($"{nameof(DDAT_DVALAVG)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[] { "21,466.0", "21,311.5", "21,788.75", "22,204.25" })]
      ...
      [SwaggerExampleValue(new string[] { "2022-10-10T01:29:59Z", "2022-10-11T19:44:59Z", "2022-10-11T22:29:59Z" })]
      List<DateTime> DDAT_PMINTM { get; set; }

      [SwaggerSchema($"{nameof(DDAT_PMINTM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[] { "10.10.2022 01:29:59", "11.10.2022 19:44:59", "11.10.2022 22:29:59" })]
      List<string> DDAT_PMINTM_FORMATTED { get; set; }

      //Bit 6 : DDAT_PMIN
      [SwaggerSchema("Minimum process value")]
      [SwaggerExampleValue(new double[] { 73.0, 78.0, 79.0 })]
      ...
      [SwaggerSchema($"{nameof(DDAT_PMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> DDAT_PMINLIM_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(DDAT_PMAXLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> DDAT_PMAXLIM_FORMATTED { get; set; }

      //Bit 12 : DDAT_PCOUNT
      [SwaggerSchema("Number of process values")]
      [SwaggerExampleValue(new int[] { 288, 288, 288 })]
      List<uint> DDAT_PCOUNT { get; set; }

      [SwaggerSchema($"{nameof(DDAT_PCOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> DDAT_PCOUNT_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(DDAT_IMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> DDAT_IMINLIM_FORMATTED { get; set; }

      //Bit 22 : DDAT_IMAXLIM
      [SwaggerSchema("Number of range limit exceedings - interval values")]
      [SwaggerExampleValue(new int[] { 12, 12, 12 })]
      List<uint> DDAT_IMAXLIM { get; set; }

      [SwaggerSchema($"{nameof(DDAT_IMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> DDAT_IMAXLIM_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(DDAT_ICOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "12", "12", "12"})]
      List<string> DDAT_ICOUNT_FORMATTED { get; set; }
