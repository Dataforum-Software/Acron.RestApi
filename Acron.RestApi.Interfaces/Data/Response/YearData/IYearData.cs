...
namespace Acron.RestApi.Interfaces.Data.Response.YearData
{
   public interface IYearData<YearDataFlagType> where YearDataFlagType : IYearDataFlag
   {
      ...
      [SwaggerExampleValue(typeof(IYearDataFlag))]
      public List<YearDataFlagType> YDAT_FLAG { get; set; }

      //2   	YDAT_YVAL	         double      Wert
      [SwaggerSchema("Annual value")]
      [SwaggerExampleValue(new double[] { 5114232.0 })]
      public List<double> YDAT_YVAL { get; set; }

      [SwaggerSchema($"{nameof(YDAT_YVAL)} formatted according to 'Culture' Header or value key")]
      [SwaggerExampleValue(new string[] { "5.114.232,0" })]
      ...
      [SwaggerExampleValue(new int[] { 0 })]
      public List<uint> YDAT_PMINLIM { get; set; }

      [SwaggerSchema($"{nameof(YDAT_PMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> YDAT_PMINLIM_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(YDAT_PMAXLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> YDAT_PMAXLIM_FORMATTED { get; set; }

      //17	YDAT_PCOUNT	      unsigned	   Anzahl der Prozesswerte
      [SwaggerSchema("Number of process value")]
      [SwaggerExampleValue(new int[] { 98083 })]
      public List<uint> YDAT_PCOUNT { get; set; }

      [SwaggerSchema($"{nameof(YDAT_PCOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[] { "98.083" })]
      List<string> YDAT_PCOUNT_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(YDAT_IMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> YDAT_IMINLIM_FORMATTED { get; set; }
      ...
      [SwaggerExampleValue(new int[] { 2568 })]
      public List<uint> YDAT_IMAXLIM { get; set; }

      [SwaggerSchema($"{nameof(YDAT_IMAXLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "2.568" })]
      List<string> YDAT_IMAXLIM_FORMATTED { get; set; }

      //25	YDAT_ICOUNT	      unsigned	   Anzahl der Intervallwerte im Tag
      [SwaggerSchema("Number of interval values")]
      [SwaggerExampleValue(new int[] { 4087 })]
      public List<uint> YDAT_ICOUNT { get; set; }

      [SwaggerSchema($"{nameof(YDAT_ICOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "4.087" })]
      List<string> YDAT_ICOUNT_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(YDAT_DMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> YDAT_DMINLIM_FORMATTED { get; set; }
      ...
      [SwaggerExampleValue(new int[] { 1339 })]
      public List<uint> YDAT_DMAXLIM { get; set; }

      [SwaggerSchema($"{nameof(YDAT_DMAXLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "1.339" })]
      List<string> YDAT_DMAXLIM_FORMATTED { get; set; }

      //33	YDAT_DCOUNT	      unsigned	   Anzahl der Tageswerte
      [SwaggerSchema("Number of daily values")]
      [SwaggerExampleValue(new int[] { 1341 })]
      public List<uint> YDAT_DCOUNT { get; set; }

      [SwaggerSchema($"{nameof(YDAT_DCOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "1.341" })]
      List<string> YDAT_DCOUNT_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(YDAT_MMINLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "0", "0", "0"})]
      List<string> YDAT_MMINLIM_FORMATTED { get; set; }
      ...
      [SwaggerExampleValue(new int[] { 49 })]
      public List<uint> YDAT_MMAXLIM { get; set; }

      [SwaggerSchema($"{nameof(YDAT_MMAXLIM)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "49" })]
      List<string> YDAT_MMAXLIM_FORMATTED { get; set; }
      ...
      [SwaggerSchema($"{nameof(YDAT_MCOUNT)} formatted according to 'Culture' Header")]
      [SwaggerExampleValue(new string[]{ "49" })]
      List<string> YDAT_MCOUNT_FORMATTED { get; set; }
