...
{
   internal abstract class ConfigUnitWrapper : ObservableObject, IWrapper
   {
      #region ctor
      public ConfigUnitWrapper(RestClient client)
      {
         _myConfigurationRequest = new ConfigurationUnitRequests(client);
         Name = string.Empty;
         ...
         if (_myConfigurationRequest is null)
            return;
         string helper = "Unit_" + GetType().Name.Replace("Wrapper", "");
      ...
      protected ConfigurationUnitRequests? _myConfigurationRequest;
