...
{
   internal abstract class ConfigGeneralWrapper : ObservableObject, IWrapper
   {
      #region ctor
      public ConfigGeneralWrapper(ConfigurationGeneralRequests? requests = null)
      {
         _myConfigurationRequest = requests;
         Name = string.Empty;
      ...
      protected ConfigurationGeneralRequests? _myConfigurationRequest;
