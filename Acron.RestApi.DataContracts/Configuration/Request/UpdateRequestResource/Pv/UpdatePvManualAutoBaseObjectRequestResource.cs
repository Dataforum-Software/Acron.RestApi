...
{
   [DataContract]
   public class UpdatePvManualAutoBaseObjectRequestResource : UpdatePvBaseObjectRequestResource, IUpdatePvManualAutoBaseObjectRequestResource
   {
      #region cTor

      public UpdatePvManualAutoBaseObjectRequestResource(BaseObjectDefines.RestObjectTypeCode typeCode)
         : base(typeCode)
      { }
