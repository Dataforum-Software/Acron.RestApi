...
{
   [DataContract]
   public class UpdatePvManualObjectRequestResource : UpdatePvManualAutoBaseObjectRequestResource, IUpdatePvManualObjectRequestResource
   {
      #region cTor

      public UpdatePvManualObjectRequestResource()
