...
{
   [DataContract]
   public class UpdateProviderObjectRequestResource : UpdateProviderBaseObjectRequestResource, IUpdateProviderObjectRequestResource
   {
      #region cTor

      public UpdateProviderObjectRequestResource()
