...
{
   [DataContract]
   public class CreateConnectionObjectRequestResource : CreateBaseObjectRequestResource, ICreateConnectionObjectRequestResource
   {
      #region cTor

      public CreateConnectionObjectRequestResource()
