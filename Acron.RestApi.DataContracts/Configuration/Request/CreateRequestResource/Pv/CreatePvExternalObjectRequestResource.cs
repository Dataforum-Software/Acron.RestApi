...
{
   [DataContract]
   public class CreatePvExternalObjectRequestResource : CreateBaseObjectRequestResource, ICreatePvExternalObjectRequestResource
   {
      #region cTor

      public CreatePvExternalObjectRequestResource()
