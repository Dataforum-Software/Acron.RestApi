...
{
   [DataContract]
   public class CreatePvCalcObjectRequestResource : CreatePvBaseObjectRequestResource, ICreatePvCalcObjectRequestResource
   {
      #region cTor

      public CreatePvCalcObjectRequestResource()
      ...
      public CreatePvCalcObjectRequestResource(BaseObjectDefines.RestObjectTypeCode typeCode)
         : base(typeCode)
      { }
