...
{
   [DataContract]
   public class CreatePvBaseObjectRequestResource : CreateBaseObjectRequestResource, ICreatePvBaseObjectRequestResource
   {
      #region cTor

      public CreatePvBaseObjectRequestResource(BaseObjectDefines.RestObjectTypeCode typeCode)
         : base(typeCode)
      { }
