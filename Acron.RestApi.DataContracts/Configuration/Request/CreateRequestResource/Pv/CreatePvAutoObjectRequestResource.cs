...
{
   [DataContract]
   public class CreatePvAutoObjectRequestResource : CreatePvManualAutoBaseObjectRequestResource, ICreatePvAutoObjectRequestResource
   {
      #region cTor

      public CreatePvAutoObjectRequestResource()
