...
{
   [DataContract]
   public class CreateExtVarObjectRequestResource : CreateBaseObjectRequestResource, ICreateExtVarObjectRequestResource
   {
      #region cTor

      public CreateExtVarObjectRequestResource()
