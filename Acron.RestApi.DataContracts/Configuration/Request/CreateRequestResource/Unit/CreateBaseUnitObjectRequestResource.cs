...
{
   [DataContract]
   public class CreateBaseUnitObjectRequestResource : CreateUnitBaseRequestResource, ICreateBaseUnitObjectRequestResource
   {
      #region cTor

      public CreateBaseUnitObjectRequestResource()
