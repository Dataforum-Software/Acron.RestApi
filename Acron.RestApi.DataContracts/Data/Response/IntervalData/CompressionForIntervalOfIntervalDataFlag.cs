...
{
   [DataContract]
   public class CompressionForIntervalOfIntervalDataFlag : ICompressionForIntervalOfIntervalDataFlag
   {
      [DataMember]
      ...
      [DataMember]
      public bool ICOMPDAT_GREATER { get; set; }

      [DataMember]
      public bool ICOMPDAT_NOREL { get; set; }

      [DataMember]
      public bool ICOMPDAT_MISSING { get; set; }

      [DataMember]
      public bool ICOMPDAT_UNDER_LIMIT { get; set; }

      [DataMember]
      public bool ICOMPDAT_OVER_LIMIT { get; set; }
