...
{
   [DataContract]
   public class GetHandValRawDataDayValue : IGetHandValRawDataDayValue<GetHandValRawDataValue, GetHandValRawDataFlag>
   {
      [DataMember]
      ...
      [DataMember]
      public List<GetHandValRawDataValue> Data { get; set; } = new List<GetHandValRawDataValue>();
   }
}
